...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "100px"
			.Title = "TABLE CDMAPART;HEADING;POS [Cell#]"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter exact requested information:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: Cell No- 3039x", "terminate=newline")
			.AddItem Array("type=text", "name=s_strCascade", "label=Enter Cell No:", "accesskey=p", "value=" & s_strCascade, "size=9", "terminate=newline")
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "TABLE CDMAPART;HEADING;POS " & s_strCascade 
