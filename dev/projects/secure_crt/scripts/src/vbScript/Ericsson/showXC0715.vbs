...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "100px"
			.Title = "show XC | include [EOAM Vlan]"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter exact requested information:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: EOAM VLan 3505", "terminate=newline")
...
'			s_strPort = .Responses.Item("s_strPort")           
		...
		If (s_objUtils.TestLengthMinMax(s_strSvlan, "Cascade ID", 3, 5)) Then
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show XC | include " & s_strSvlan
