...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "120px"
			.Title = "show qos cir | i  [BH_VLAN_ID] "
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter exact requested information:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: BH Mgmt VLan 3505", "terminate=newline")
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show qos cir | include " & s_strSvlan
