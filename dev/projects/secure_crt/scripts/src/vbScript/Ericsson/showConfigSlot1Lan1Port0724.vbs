...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "75px"
			.Title = "show config slot 1 lan 1 [port] ifstatistics"
...
'			s_strSvlan = .Responses.Item("s_strSvlan")           
		...
		If (s_objUtils.TestLengthMinMax(s_strPort, "Port Number", 3, 6)) then
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show config slot 1 lan 1 " & s_strPort & " ifstatistics"
