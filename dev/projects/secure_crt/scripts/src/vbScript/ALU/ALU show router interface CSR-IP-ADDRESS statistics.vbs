...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 450
			.LabelWidths = "75px"
			.Title = "show router interface [CSR IP ADDRESS] statistics"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter CSR IP Address:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: 214.17.223.60", "terminate=newline")
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show router interface " & s_strPort & " statistics"
