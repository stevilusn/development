...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 400
			.LabelWidths = "75px"
			.Title = "Show log log-id 99 | match | [port] context all"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter exact requested information:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: Port 1/2  or 1/2/7", "terminate=newline")
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show log log-id 99 | match | " & s_strPort & "context all "
