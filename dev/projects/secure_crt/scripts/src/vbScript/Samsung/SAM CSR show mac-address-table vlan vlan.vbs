...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "100px"
			.Title = "show mac-address-table vlan [vlan]"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter exact requested information:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: VLan 2929", "terminate=newline")
...
'			s_strCascade = .Responses.Item("s_strCascade")   
		...
		If (s_objUtils.TestLengthMinMax(s_strSvlan, "VLan", 2, 9)) then
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show mac-address-table vlan " & s_strSvlan
