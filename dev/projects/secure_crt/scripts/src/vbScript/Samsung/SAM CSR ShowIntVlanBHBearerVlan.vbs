...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "100px"
			.Title = "show int vlan [BH Bearer vlan]"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter exact requested information:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: BH Bearer VLan 2929", "terminate=newline")
...
'			.AddItem Array("type=text", "name=s_strPort", "label=Enter Port:", "accesskey=p", "value=" & s_strPort, "size=10", "terminate=newline")
			.AddItem Array("type=text", "name=s_strSvlan", "label=Enter BH Bearer VLan:", "accesskey=s", "value=" & s_strSvlan, "size=10", "terminate=newline")
			.Show
