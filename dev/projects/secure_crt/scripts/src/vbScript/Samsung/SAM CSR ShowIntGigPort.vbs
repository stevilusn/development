...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "75px"
			.Title = "show interface gig [port]"
			.AddItem Array("type=paragraph", "name=label1", "value= Please enter TenGige Port:", "terminate=newline")
			.AddItem Array("type=paragraph", "name=label1", "value= Example: Port 0/0", "terminate=newline")
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show interface gig " & s_strPort
