...
Function get_user_data()
	...
	Do 	
		With s_objDialogBox
			...
			.Width = 375
			.LabelWidths = "175px"
			.Title = "show run | inlcude [CSRHOSTNAME-CSID-1]"
			...
			.AddItem Array("type=paragraph", "name=label1", "value= Example: CMTPINBM-DNR-1", "terminate=newline")
...
'			s_strSvlan = .Responses.Item("s_strSvlan")           
		...
		If (s_objUtils.TestLengthMinMax(s_strPort, "Port Number", 3, 15)) then
...
Sub issue_PORTSVLAN_command()
	s_objUtils.Send "show run | include " & s_strPort
